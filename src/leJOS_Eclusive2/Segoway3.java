 ...
 *                                                                                                                                                                                                                                                             
 */                                                                                                              
public class Segoway3 extends Thread {                                                                               
	private Thread t;                                                                                        
	...
	double [] offsetA            = new double [TestInterval]  ; 
	...
	double [] SmoothDeltaA       = new double [TestInterval]  ;
	double [] tSmoothedIntervalA = new double [TestInterval]  ;
	 ...
	 *            tires in mm) 
	 */                                                                                                                                 
	public Segoway3(int run, UnregulatedMotor left, UnregulatedMotor right, EV3GyroSensor ev3Gyro, double wheelDiameter) { 
        ...
        System.out.println("Entering Segoway");                                                                  
	...
	private void calibrateGyro() {                                                      //  From krchilders                             
		System.out.println("Entering calibrateGyro");LCD.clear();                                                                    //  From krchilders                          
	...
	private void startBeeps() {                                                                                                                                             
		...
		System.out.println("Entering startBeeps");
	...
	private void updateGyroData() {                                                          //  From krchilders                                                                       
	    ...
	    //System.out.println("At loopCount(" + (loopCount+1) + "):  gyroSpeed(" + gyroSpeed + ") = gyroRaw(" + gyroRaw + ") - offset(" + offset + ")");                                                                                             
	...
	private void updateMotorData() {            
        ...
        //System.out.println("mrcLeft=" + mrcLeft + "    mrcRight=" + mrcRight);                                                                              
		// Maintain previous mrcSum so that delta can be calculated and get 
		// new mrcSum and difference (Diff) values      
		mrcSumPrev = mrcSum;                
	...
	public void run() {    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////           
		...
		mrcLeft  =  left_motor. getTachoCount();        
		mrcRight =  right_motor.getTachoCount(); 
        System.out.println("resetTachoCount: mrcLeft=" + mrcLeft + "    mrcRight=" + mrcRight);                                                                              
		...
		while (balancing) {    ///////////////////////////////////////////////////////////////////////////////                                                                                                             
		     ...
		     if (Debug)                                                                                     //                                                                                                                          
		    	...
		    	//motorSpeed = SmoothDelta / tSmoothedInterval;                                //           //            
			        if (loopCount <= TestInterval)                                             //           //                                                                                                                    
						...
						gyroRawA           [loopCount - 1]  =  gyroRaw;                  //    //           //              
						offsetA            [loopCount - 1]  =  offset;                   //    //           //                      
						...
						SmoothDeltaA       [loopCount - 1]  =  SmoothDelta;              //    //           //          
						tSmoothedIntervalA [loopCount - 1]  =  tSmoothedInterval;        //    //           //          
			...
			//smoothPower = 0.7 * smoothPower + 0.3 * power;                                                  //                                                                                                                
			//smoothPower = 0.8 * smoothPower + 0.2 * power;                                                //                                                                                                                                                                              
			//smoothPower = 0.9 * smoothPower + 0.1 * power;                                                //                                                                                                                                                                              
			//smoothPower = 0.8 * smoothPower + 0.2 * power;                                                //                                                                                                                                                                              
			//smoothPower = 0.7 * smoothPower + 0.3 * power;                                                  //                                                                                                                
			smoothPower = 0.6 * smoothPower + 0.4 * power;                                                //                                                                                                           
			...
			freeMemory =  Runtime.getRuntime().freeMemory();                                                //                                                                                                        
                                                                                                            //                                                                                                            
		                   	                                                                                //                                                                                                     
                                                                                                            //                                                                               
			//if (RunTimeS % 20 < 1) System.out.println(fatigue);                                           //                                                                                                             
			if (fatigue > TIME_FALL_LIMIT)    	balancing = false;                                          //                                                                                                       
			Delay.msDelay(1);                                                                               //                                                                                                                  
		...
		System.out.printf("After %2.0f minutes %2.0f seconds and %6d iterations the average loop time is %5.3f ms\n",  RunTimeS/60, RunTimeS%60, loopCount,  AverageMS);                                                                                                                                                                                                
		
		try {                                                                                                                                                                                                                            
			bw.write(                                                                                                                                                                                                                                                                                                                                          
					"  , runNum,  loopCount, i,    j,     loopCountA[j],  tIntervalA[j],  RunTimeMSA[j],  RunTimeSA[j], gyroRawA[j], offsetA[j],  gyroSpeedA[j],   gyroAngleA[j], motorPosA[j],   mrcDeltaP1A[j],    mrcDeltaP2A[j],    mrcDeltaP3A[j],   SmoothDelta, tSmoothedInterval, motorSpeedA[j],  powerA[j],  powerLeftA[j],  motorControlDriveA[j],       freeMemoryA[j]    "); 
			bw.newLine();                                                                                                                                                                                                                                                                              
			...
			if (j < TestInterval) {                                                                                                                                                                                                     
				try {                                                                                                                                                                                                                  
			        ...
			        bw.write(String.format(                                                                                                                                                                                                                                                                                                                                                                                    
							   "%5d,     %5d,   %10d,  %10d,      %10d,          %10.10f,       %10.10f,       %10.10f,      %10.10f,     %10.10f ,             %10.10f,                   %10.10f,                %10.10f,                   %10d,               %10d,             %10d,            %10.10f,           %10.10f,               %10.10f,              %10.10f,      %10.10f,          %10.10f,                    %10d,         ",                                        
						      runNum,  loopCount,  i,    j,     loopCountA[j],  tIntervalA[j],  RunTimeMSA[j],  RunTimeSA[j], gyroRawA[j], offsetA[j],  KGYROSPEED * gyroSpeedA[j],   KGYROANGLE * gyroAngleA[j], KPOS * motorPosA[j],   mrcDeltaP1A[j],    mrcDeltaP2A[j],    mrcDeltaP3A[j],   SmoothDeltaA[j], tSmoothedIntervalA[j], KSPEED * motorSpeedA[j],  powerA[j],  powerLeftA[j],  motorControlDriveA[j],       freeMemoryA[j]    ));                
					bw.newLine();                                                                                                                                                                                                                                                                                                                                                                                                       
				} catch (IOException e) {                                                                                                                                                                                                                                                           
					// TODO Auto-generated catch block                                                                                                                                                                                    
					e.printStackTrace();                                                                                                                                                                                                     
		...
		System.out.println("\nStop the program here to save the data for this run.\n\nOtherwise, wait one(1) second .\n\nThen press any key to continue.\n\nWait . . .\n");                                                                                                                                                   
		Delay.msDelay(10000);                                                                                                                                                                                                         
